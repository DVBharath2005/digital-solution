...
<img src="https://i.ibb.co/Fk0qfsYZ/photo.png" alt="Srinu Reddy" className="w-full max-w-[320px] aspect-[3/4] rounded-[32px] overflow-hidden shadow-2xl shrink-0 object-cover" />
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {days.map((d, i) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-6">Day {d.day}: {d.title}</h3>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-white rounded-[40px] shadow-2xl overflow-hidden grid lg:grid-cols-2">
          <div className="p-10 md:p-16 bg-[linear-gradient(to_bottom_right,var(--color-brand-purple),var(--color-brand-blue))] text-white">
            <h2 className="text-4xl font-[Space_Grotesk] font-bold mb-8">Secure Your Spot – ₹199</h2>
          ...
          <div className="p-10 md:p-16 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-6">
              <div className="text-center">
                ...
                <img src="https://i.ibb.co/F1bctTq/QR.png" alt="UPI Payment QR Code" className="w-48 h-48 max-w-full mx-auto object-contain rounded-2xl border border-slate-200 shadow-inner" />
              </div>
